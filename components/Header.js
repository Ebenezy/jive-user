    ...
    return (
      <div>
        <AppBar style={{backgroundColor:'#FFF'}}
          ...
          <Toolbar style={{borderBottomColor:"rgb(251, 140, 0)"}}>
            <IconButton
            ...
            <div className={classes.sectionDesktop}>
              ...
              <IconButton color="inherit">
                ...
                >
                 ...
                 {}
                 <Link to="/"   onClick={this.logout} > <img style={{width:35,height:35}}alt="" src={notification}></img></Link>
                </Badge>
